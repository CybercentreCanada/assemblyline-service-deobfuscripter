...
class DeobfuScripter(ServiceBase):
    ...
    # TODO: implement atob in Multidecoder, we shouldn't be doing base64 raw in deobfuscripter
    # head: bytes
    # bmatch: bytes
    # tail: bytes
    ...
    # TODO: Make sure decode wrapper handles file type based extraction of base64
